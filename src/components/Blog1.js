  ...
  render() {
    return (
      <div className="blog1">
        ...
        <p>
          This article will help show you how to take your React development
          build to production and host it using Heroku.
        </p>

        <p>
          <a href="https://reactjs.org/docs/getting-started.html">Facebook</a>{" "}
          does a great job in showing you how to get started using{" "}
          <a href="https://reactjs.org/docs/create-a-new-react-app.html#create-react-app">
            create-react-app
          </a>
          , but deploying to production can sometimes get confusing, as there
          are many steps to take to assure the build works properly with Heroku
        </p>

        <p>
          Let's now look at the process of correctly deploying your React app to
          Heroku.
        </p>
        ...
        <p>
          Install create-react-app and create your app, then navigate into the
          project folder:
        </p>
        ...
        <p>
          Now, create a static.json file in the root of your project directory:
        </p>
        ...
        <p>
          ...
          <a href="https://signup.heroku.com/">Heroku</a> and{" "}
        ...
        <p>
          If you haven't already created your app in Heroku, do the following:
        </p>
        <p className="code-box">
          $ heroku create Your-App --buildpack
          https://github.com/mars/create-react-app-buildpack.git <br />
          $ git add . <br />
        ...
        <p className="code-box">
          $ heroku git:remote --app Your-App>
          <br />
